...
setup(
    ...
    package_dir={"": "."},
    package_data={},
    install_requires=['async-timeout==3.*,>=3.0.0', 'asyncio-dgram==1.*,>=1.0.0', 'backoff==1.*,>=1.10.0', 'cached-property==1.*,>=1.5.2', 'click==7.*,>=7.0.0', 'pid<4.0,>=2.2', 'pydantic[dotenv]==1.*,>=1.4.0', 'pylru==1.*,>=1.2.0', 'pyroute2==0.*,>=0.5.10', 'python-dotenv<0.15.0,>=0.10.3', 'pyyaml==5.*,>=5.2.0', 'sentry-sdk<0.17.0,>=0.14.3', 'uvloop==0.14.0'],
